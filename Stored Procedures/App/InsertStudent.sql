CREATE PROCEDURE InsertStudent
	...
	@trackname VARCHAR(50), @branchname VARCHAR(50)
AS
BEGIN
	DECLARE @trackid INT 
	SELECT @trackid = TrackID FROM Track WHERE TrackName = @trackname

    INSERT INTO Student (FirstName, LastName, Age, Gender, Phone, [Location], Faculty, GraduationYear, Email, [Password], TrackID)
    VALUES (@firstname, @lastname, @age, @gender, @phone, @location, @faculty, @gradutaionyear,@email, @Password, @trackid)
END;
